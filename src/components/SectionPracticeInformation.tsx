	...
	return (
		<section className="section-level-up">
			...
			<div className="details">
				...
				<p className="text pb-2">何が言いたいかというと、確認フォームをするとその箇所の情報が増加します。</p>
				<p className="text pb-2">情報は練習の意識次第で変化していきます。</p>
				<p className="text pb-2">フォームの部位を認識していると情報が蓄積していくので計画するパタンの材料になります。</p>
				...
				<div className="details-result p-8">
					{selectSportsPracticeInfoList.map((sportsGrowthItem) => <div key={sportsGrowthItem.categoryId} className="">
				...
				<p className="text pb-2">練習量で増えた情報を利用して計画を再評価させていきましょう。</p>
				<div className="pb-2">
					<Button
						label="計画の再評価へ移行"
