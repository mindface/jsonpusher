				...
				<div className="case-box pb-2">
					<ul className="list border rounded-lg p-4">
						<li className="item">
							...
							<p className="pb-2">スコアやグラフで記録することを検討する。例として、動作のスムーズさ、強度の向上、持続時間などを定期的に測定する。</p>
						</li>
						<li className="item">
							<p className="pb-4 font-bold">・ビデオ記録</p>
							<p className="pb-2">パフォーマンスを撮影し、動作の改善点や姿勢の変化を目視で比較する。特に身体のシンメトリーや動きの滑らかさに注目する。</p>
						</li>
						<li className="item">
							<p className="pb-4 font-bold">・スコアシート作成</p>
							<p className="pb-2">重要な評価基準をリストアップして、それぞれに自己評価やコーチからのフィードバックを記載するようなシートを作成する。</p>
						</li>
						<li className="item">
							<p className="pb-4 font-bold">・主観的な情報の記録</p>
							<p className="pb-2">食事や疲れなどについて、定量化ができなければ主観的なテキストで記録する。</p>
						</li>
					</ul>
				</div>
