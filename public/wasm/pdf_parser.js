 ...
 * @returns {string}
 */
export function parse_pdf(pdf_data) {
    let deferred3_0;
    let deferred3_1;
    try {
...
export class Calculator {
     ...
     * @returns {number}
     */
    calculate_square_sum(input) {
        const ptr0 = passArrayF64ToWasm0(input, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.calculator_calculate_square_sum(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @param {string} input
    ...
    validate_data(input) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.calculator_validate_data(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('pdf_parser_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
